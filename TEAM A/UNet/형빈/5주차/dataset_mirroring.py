...
class CityscapeDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        cityscape = self.mirroring_Extrapolate(cityscape)
    ...
    def mirroring_Extrapolate(self, array):
        np_r = np.pad(array[:,:,0],((92,92),(92,92)),"reflect")
        np_g = np.pad(array[:,:,1],((92,92),(92,92)),"reflect")
        np_b = np.pad(array[:,:,2],((92,92),(92,92)),"reflect")
        mirrored_array = np.stack([np_r,np_g,np_b],axis=-1)
