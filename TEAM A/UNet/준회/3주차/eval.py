...
data_dir = '../chatbot/U-net/datasets'
ckpt_dir = '../chatbot/U-net/checkpoint'
log_dir = '../chatbot/U-net/log'
result_dir = '../chatbot/U-net/results'
